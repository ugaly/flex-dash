...
//         const ctx = callsChartRef.current.getContext("2d")
//         if (ctx) {
//           // Generate initial data points (last 20 time points)
//           const now = new Date()
//           const initialLabels = []
//           const initialIVR = []
...
//           for (let i = 19; i >= 0; i--) {
//             const time = new Date(now.getTime() - i * 3000) // 3 seconds apart
//             const timeLabel = `${time.getHours()}:${time.getMinutes() < 10 ? "0" : ""}${time.getMinutes()}`
//             initialLabels.push(timeLabel)
//             initialIVR.push(generateRandomNumber(5, 20))
//             initialOutgoing.push(generateRandomNumber(2, 10))
//             initialWaiting.push(generateRandomNumber(0, 8))
//             initialAnswered.push(generateRandomNumber(10, 30))
//           }
...
//       callsChartInstance.current.update("none")
//     }
...
//         Number.parseInt(item.calls),
//       )
//       hourlyChartInstance.current.update("none")
//     }
//   }
